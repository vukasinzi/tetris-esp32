...
void IRAM_ATTR onLeftButton() {leftInterrupt = true;}
void IRAM_ATTR onRightButton(){rightInterrupt = true;}
void IRAM_ATTR onDownButton(){downInterrupt = true;}
void IRAM_ATTR onRotationButton(){rotateInterrupt = true;}
